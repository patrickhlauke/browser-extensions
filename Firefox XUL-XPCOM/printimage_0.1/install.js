...
var XpiInstaller = {
	...
	extFullName: 'Print Image', // The name displayed to the user (don't include the version)
	extShortName: 'printimage', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Patrick H. Lauke aka redux',
