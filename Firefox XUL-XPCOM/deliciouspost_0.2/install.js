...
var XpiInstaller = {
	...
	extFullName: 'Del.icio.us post', // The name displayed to the user (don't include the version)
	extShortName: 'deliciouspost', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.2',
