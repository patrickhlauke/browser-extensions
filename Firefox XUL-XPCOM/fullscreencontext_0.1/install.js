...
var XpiInstaller = {
	...
	extFullName: 'Full Screen context', // The name displayed to the user (don't include the version)
	extShortName: 'fullscreencontext', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Patrick H. Lauke',
