...
var XpiInstaller = {
	...
	extFullName: 'Text size toolbar', // The name displayed to the user (don't include the version)
	extShortName: 'text_size', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.3',
