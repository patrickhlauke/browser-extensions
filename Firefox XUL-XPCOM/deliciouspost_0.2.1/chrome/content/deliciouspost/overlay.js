// del.icio.us post 0.21
// Created by Patrick H. Lauke aka redux - http://www.splintered.co.uk - February 2005
...
function delicious_post_context(e) {
	if(gContextMenu.onLink) {
		...
		delicious_post_description = (link.firstChild ? link.firstChild.nodeValue : link.nodeValue); // experimental
	} else {
...
function delicious_post_submit() {
	window.openDialog("chrome://deliciouspost/content/dialogs/submit.xul", "delicious-post-dialog", "centerscreen,chrome,modal",delicious_post_url,delicious_post_description);
}
