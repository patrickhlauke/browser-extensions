...
var XpiInstaller = {
	...
	extFullName: 'Dublin Core Viewer', // The name displayed to the user (don't include the version)
	extShortName: 'dublincore', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
